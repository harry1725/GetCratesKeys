        ...
        if (gck.getConfig().getBoolean("config.enabled")) {
            ...
            if (gck.getConfig().getBoolean("config.dropBoost.enabled")) {
                ...
                if (gck.getConfig().getInt("config.dropBoost.amount") < 1) {
                    ...
                    player.sendMessage(ChatColor.WHITE + "현재 " + ChatColor.GREEN + gck.getConfig().getInt("config.dropBoost.amount") + ChatColor.WHITE + " 개의 " + ChatColor.YELLOW + "열쇠 추가 드랍" + ChatColor.WHITE + "이 " + ChatColor.GREEN + "활성화" + ChatColor.WHITE + " 되어있습니다!");
                }
                if (gck.getConfig().getInt("config.dropBoost.chance") == 0) {
                    ...
                    if (gck.getConfig().getInt("config.dropBoost.chance") < 0) {
                        player.sendMessage(ChatColor.WHITE + "현재 " + ChatColor.RED + gck.getConfig().getInt("config.dropBoost.chance") + ChatColor.RED + "%" + ChatColor.WHITE + "만큼의 " + ChatColor.YELLOW + "열쇠 드랍 확률 부스트" + ChatColor.WHITE + "가 " + ChatColor.GREEN + "활성화" + ChatColor.WHITE + " 되어있습니다!");
                    } else {
                        player.sendMessage(ChatColor.WHITE + "현재 " + ChatColor.GREEN + "+" + ChatColor.GREEN + gck.getConfig().getInt("config.dropBoost.chance") + ChatColor.GREEN + "%" + ChatColor.WHITE + "만큼의 " + ChatColor.YELLOW + "열쇠 드랍 확률 부스트" + ChatColor.WHITE + "가 " + ChatColor.GREEN + "활성화" + ChatColor.WHITE + " 되어있습니다!");
                    }
                }
            } else {
