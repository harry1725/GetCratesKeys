                        ...
                        if (gck.getConfig().getBoolean("config.enabled")) {
                            ...
                            for (int i = 1; i <= total_key_num; i++) {
                                if (gck.getKeysConfig().getBoolean("keys._" + (i + 1) + ".enabled")) {
                                    player.sendMessage(ChatColor.GREEN + gck.getKeysConfig().getString("keys._" + (i + 1) + ".display_name"));
                                } else {
                                    player.sendMessage(ChatColor.RED + gck.getKeysConfig().getString("keys._" + (i + 1) + ".display_name"));
                                }
                            }
                        } else {
